...
const getEmailDomain = (emailAddress) => emailAddress.split('@')[1];
...
const typeOfEmail = (emailAddress) => {
...
const checkEmailValidity = (emailAddress) => {
    return emailAddress.includes("@") && !emailAddress.includes(",") && !emailAddress.slice(-1).includes(".");
}
